            ...
            <Section className={style.section} kind="primary" size="normal">
                ...
                <Row>
                    <Col xs="12" sm="6" className={style.teamBuilding}>
                        <Card image={orderSnowminerIcon} title="How We Do: Team Building" paragraph="Aliquam sed nulla sollicitudin, cursus ante et, dictum lacus. Cras ut magna quis tortor." button="Read More" />
                    </Col>
                    <Col xs="12" sm="6" className={style.funStuff}>
                        <Card image={orderSnowminerIcon} title="Focus on the Fun Stuff" paragraph="Aliquam sed nulla sollicitudin, cursus ante et, dictum lacus. Cras ut magna quis tortor." button="Read More" />
                    </Col>
                </Row>
